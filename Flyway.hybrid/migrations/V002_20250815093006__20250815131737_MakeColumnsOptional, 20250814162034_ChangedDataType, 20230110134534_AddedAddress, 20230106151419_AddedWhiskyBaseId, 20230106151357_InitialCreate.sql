...
GO
ALTER TABLE [dbo].[Bottles] ALTER COLUMN [Name] [nvarchar] (max) NULL
GO
ALTER TABLE [dbo].[Bottles] ALTER COLUMN [DistilleryId] [int] NULL
GO
...
GO
ALTER TABLE [dbo].[Distilleries] ALTER COLUMN [Name] [nvarchar] (max) NULL
GO
ALTER TABLE [dbo].[Distilleries] ALTER COLUMN [Location] [nvarchar] (max) NULL
GO
PRINT N'Altering [dbo].[Orders]'
GO
ALTER TABLE [dbo].[Orders] ALTER COLUMN [CustomerId] [int] NULL
GO
ALTER TABLE [dbo].[Orders] ALTER COLUMN [BottleId] [int] NULL
GO
...
GO
ALTER TABLE [dbo].[Customers] ALTER COLUMN [FirstName] [nvarchar] (max) NULL
GO
ALTER TABLE [dbo].[Customers] ALTER COLUMN [LastName] [nvarchar] (max) NULL
GO
ALTER TABLE [dbo].[Customers] ALTER COLUMN [Address] [nvarchar] (max) NULL
GO
PRINT N'Altering [dbo].[Tastings]'
GO
ALTER TABLE [dbo].[Tastings] ALTER COLUMN [BottleId] [int] NULL
GO
ALTER TABLE [dbo].[Tastings] ALTER COLUMN [CustomerId] [int] NULL
GO
ALTER TABLE [dbo].[Tastings] ALTER COLUMN [Notes] [nvarchar] (max) NULL
GO
...
GO
ALTER TABLE [dbo].[Bottles] ADD CONSTRAINT [FK_Bottles_Distilleries_DistilleryId] FOREIGN KEY ([DistilleryId]) REFERENCES [dbo].[Distilleries] ([Id])
GO
